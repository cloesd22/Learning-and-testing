...
//now to remove the bindings

eventspewer.removeListener('connection', ear1);
console.log("ear 1 offline");

//eventspewer.removeListener('connection', ear2);
//console.log("ear2 offline");

var eventlisteners = require('events').EventEmitter.listenerCount(eventspewer,'connection')
console.log(eventlisteners + " is the number of listeners currently connected");
